...
main (int argc, char *argv[])
{
  ...
  Config::SetDefault ("ns3::TcpSocketBase::MaxWindowSize",UintegerValue (300));
  ...
  uint16_t chokehandle = tchChoke.SetRootQueueDisc ("ns3::ChokeQueueDisc", "LinkBandwidth", StringValue ("1Mbps"),                                                                   "LinkDelay",StringValue ("1ms"));
  ...
  p2pBottleneck.SetQueue ("ns3::DropRandomQueue");
  ...
  apps.Start (Seconds (0.0));
  apps.Stop (Seconds (120.0));
  sourceAndSinkApp.Start (Seconds (0.0));
